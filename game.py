...
from charactere import Monster
...
class Game:
    ...
    def setup(self):
        ...
        quete_principale = Quest( "Sauver votre femme", "Votre femme est retenue quelque part dans cette ville. Explorez les lieux et trouvez des indices pour la libérer.", objectives=["Accéder à la cave"], reward=None)
...
|________|    --   --Martin Street-   __   __   __                 __   __   __   __   _ Lindsey Street  __   __   __   __   
        ...
        Lindsey_street.exits={"N": None,"E": None,"O":pharma,"S":croisement}
        cave.exits={"sortie":hotel, "N": None,"E":None,"O":None,"S":None}
        hotel.exits={"sortie":Neely_street,"cave":cave, "étage": etage,"N": None,"E":None,"O":None,"S":None}
    ...
    def print_welcome(self):
        print(f"\nBienvenue {self.player.name} dans ce jeu d'aventure/horreur textuel.\n" 
                                         "Vous venez d’arriver à Silent Hil,une ville abandonnée, autrefois paisible, aujourd’hui rongée par le silence et la peur.\n" 
